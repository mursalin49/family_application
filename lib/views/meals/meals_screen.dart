...
class _MealsScreenState extends State<MealsScreen> {
  ...
  final MealsTabControllerX controller = Get.put(MealsTabControllerX());
  final List<String> tabs = ["Meal Plans", "Grocery List"];

  final Map<String, List<Map<String, String>>> mealPlan = {
    'Monday': [
      {'name': 'Egg Curry', 'type': 'Breakfast', 'ingredients': 'Egg, oil', 'notes': 'Spicy version'},
    ],
    'Tuesday': [],
    'Wednesday': [],
    'Thursday': [],
  ...
  void _deleteMeal(String day, int index) {
    setState(() {
      if (mealPlan.containsKey(day) && mealPlan[day]!.length > index) {
