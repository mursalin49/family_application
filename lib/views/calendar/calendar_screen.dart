...
class _CalendarScreenState extends State<CalendarScreen> {
  ...
  DateTime _selectedDay = DateTime(2025, 10, 26);
  ...
  void initState() {
    ...
    _events = CalendarEvent.getSampleEvents();
  }
  ...
  Widget _buildWeekView() {
    ...
    final daysFromSunday = (_focusedDay.weekday % 7);
  ...
  List<CalendarEvent> _getAllEvents() {
    return CalendarEvent.getSampleEvents().where((event) {
